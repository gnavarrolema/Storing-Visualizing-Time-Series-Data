...
client = influxdb_client.InfluxDBClient(
    ...
    token="njFjw9GDqgOB-ZvO4mQMn7UqhQ4dS6UufJfX2la8QCldWArvLTleuIWufE5-snbksZE8TVOQwq9n3TnHmN39lQ==",
    org="my-org",
)
...
message = write_api.write(
    bucket="live_weather", org="my-org", record=ex_df, data_frame_measurement_name="api"
)
write_api.flush()
print(message)
